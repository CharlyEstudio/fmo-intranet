...
@Component({
  selector: 'app-vencido1730',
  templateUrl: './vencido1730.component.html',
  styles: []
})
export class Vencido1730Component implements OnInit, OnDestroy {

  dia: string;

  // Morisidad de 17 a 30 días
  ...
  constructor(
    ...
    // Morosidad
    this._phpService.mor(this.dia, '1730')
      .subscribe((data) => {
        if ( data[0].importe !== 0 ) {
