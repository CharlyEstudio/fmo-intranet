...
@Component({
  selector: 'app-vencido3060',
  templateUrl: './vencido3060.component.html',
  styles: []
})
export class Vencido3060Component implements OnInit, OnDestroy {

  // Morisidad de 30 a 60 días
