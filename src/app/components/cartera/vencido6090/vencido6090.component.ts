...
@Component({
  selector: 'app-vencido6090',
  templateUrl: './vencido6090.component.html',
  styles: []
})
export class Vencido6090Component implements OnInit, OnDestroy {

  // Morisidad de 60 a más
